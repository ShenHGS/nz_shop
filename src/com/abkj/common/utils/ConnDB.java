...
public class ConnDB {
	...
	private static String dbClassName = "com.mysql.jdbc.Driver";	//驱动类的类名
	private static String dbUrl = "jdbc:mysql://localhost:3306/nz_shop?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
